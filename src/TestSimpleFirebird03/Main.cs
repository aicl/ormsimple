	...
	class MainClass
	{
		public static void Main (string[] args)
		{
			       ...
			       "User=SYSDBA;Password=masterkey;Database=employee.fdb;DataSource=localhost;Dialect=3;charset=ISO8859_1;".OpenDbConnection())
			{
				...
				//}
				//fbd.DbFactory= new ConnectionFactory("User=SYSDBA;Password=masterkey;Database=employee.fdb;DataSource=localhost;Dialect=3;charset=ISO8859_1;", new CustomFirebirdProvider());
				...
				Console.WriteLine("Columns for USERS:");
				...
				Console.WriteLine("Columns for EMPLOYEE:");
